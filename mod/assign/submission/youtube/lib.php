...
/**
 * This file contains the moodle hooks for the submission youtube plugin
 ...
 */
function assignsubmission_youtube_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $USER, $DB;
	...
	if(!($itemid==0 && $filearea="youtube_backimage")){
    ...
    $fullpath = "/{$context->id}/assignsubmission_youtube/$filearea/$itemid/$relativepath";
