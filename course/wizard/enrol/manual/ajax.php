 ...
 * derived from core_enrol (enrol/manual/ajax.php) by 2010 Sam Hemelryk
 */
...
$PAGE->set_url(new moodle_url('/course/wizard/enrol/ajax.php', array('id'=>$id, 'action'=>$action)));
...
$manager = new course_enrolment_manager_wizard($PAGE, $course);
