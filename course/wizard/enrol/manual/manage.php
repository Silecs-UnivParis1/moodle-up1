...
$PAGE->set_url('/course/wizard/enrol/manual/manage.php', array('enrolid'=>$instance->id));
$PAGE->set_title($enrol_manual->get_instance_name($instance));
$PAGE->set_heading($course->fullname);
navigation_node::override_active_url(new moodle_url('/course/wizard/enrol/users.php', array('id'=>$course->id)));
